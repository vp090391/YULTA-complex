...
import zayavkaNaOtborObrazcov from './assets/Заявка на отбор образцов.docx';
        ...
        <article className={s.article_wrapper}>
            <section className={s.section}>
                <section>
                    ...
                    <p>Обязательной сертификации подлежат строительные материалы и изделия указанные в Перечне строительных материалов и изделий, подлежащих подтверждению соответствия существенным требованиям безопасности технического регламента Республики Беларусь&ensp;
                ...
                <section>
                    ...
                    <section>
                        ...
                        <p className={s.bolded}>В случае необходимости внесения изменений и дополнений в действующий сертификат соответствия, выдачи дубликата действующего сертификата соответствия заявителю необходимо обратиться в орган по сертификации, выдавший сертификат соответствия, с письменным заявлением в свободной форме</p>
                    </section>
