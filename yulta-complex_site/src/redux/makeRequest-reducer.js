...
let initialState = {
    ...
    paragrafs: {
        ...
        3: 'Также, Вам необходимо будет подготовить образцы согласно ТНПА на продукцию и привезти их в нашу лабораторию. \n' +
    ...
    docsList: {
        ...
        list: {
            1: {
                header: '1. Заявка',
                paragraf: 'Документ оформляется на фирменном бланке организации-Заявителе в свободной форме. В документе должна быть указана следующая информация:\n' +
